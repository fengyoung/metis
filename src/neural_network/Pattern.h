...
#ifndef _METIS_NEURAL_NETWORK_PATTERN_H 
#define _METIS_NEURAL_NETWORK_PATTERN_H 
...
public:
	...
	//	ArrayFromString - parse a value array from string in format "x1,x2,...,xn"
	//
	// DESCRIPTION
	//	x: the value array
	...
	static int32_t ArrayFromString(double* x, const int32_t len, const char* sStr);
...
#endif /* _METIS_NEURAL_NETWORK_PATTERN_H */
