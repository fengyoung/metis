...
SubPerceptron::SubPerceptron() : Perceptron(), m_bUpdateCancel(false)
{
}


SubPerceptron::~SubPerceptron()
{
}


double SubPerceptron::OnceUpdate(vector<Pattern*>& vtrPatts, int32_t& nOff, const int32_t nBatchCnt, 
...
double SubPerceptron::LoopUpdate(vector<Pattern*>& vtrPatts, const int32_t nBatchCnt, 
		const double dLearningRate, const ERegula eRegula)
{
	m_bUpdateCancel = false; 
	// create assistant variables for training
...
void SubPerceptron::UpdateCancel()
{
